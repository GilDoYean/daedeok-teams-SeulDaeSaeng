...
<%
    List<BoardVO> myCommentList = (List<BoardVO>)request.getAttribute("myCommentList");
    //페이징 기능
    int itemsPerPage = 5;
    int currentPage = (request.getParameter("page") != null) ? Integer.parseInt(request.getParameter("page")) : 1;
    int totalItems = (myCommentList != null) ? myCommentList.size() : 0;
	...
	<section class="board mb-5">
		<div class="container" data-aos="fade-up">
			<div
				...
				<p class="col-3">
                               총 <b><%= (myCommentList != null) ? myCommentList.size() : 0 %></b> 개
                </p>
			</div>
			<div class="list-group">
				...
				<%
                	   ...
                	   for (int i = startIndex; i < endIndex; i++) {		   
                		   //level별 이름지정
                    	   BoardVO boardVo = myCommentList.get(i);
                %>
